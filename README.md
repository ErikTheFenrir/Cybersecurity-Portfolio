...
## Tekniska skills
- **Verktyg**: Nmap, Wireshark, Burp Suite, sqlmap, WPScan, BloodHound, theHarvester
- **Programmering**: Python (network scanning, password checkers), Bash, PowerShell, C#
- **Områden**: Web vulns (SQLi, XSS), AD-exploitation


*Uppdateras kontinuerligt med nya labs och certs.*
